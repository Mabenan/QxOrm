...
#define QX_DLL_EXPORT_TEMPLATE_HPP(CL, T)                                      \
  QX_PRAGMA_VISIBILITY_BEGIN extern template CL QX_DLL_IMPORT_TEMPLATE_HELPER  \
      T;                                                                       \
...
#define QX_DLL_EXPORT_TEMPLATE_T_U_P1_CPP(CL, T, U, P1)                        \
  QX_PRAGMA_VISIBILITY_BEGIN template CL QX_DLL_EXPORT_TEMPLATE_HELPER         \
      T<U<P1>>;                                                                \
  QX_PRAGMA_VISIBILITY_END
...
#define QX_DLL_EXPORT_QX_SINGLETON_HPP(x)                                      \
  QX_DLL_EXPORT_TEMPLATE_HPP(class, qx::QxSingleton<x>)
#endif // _QX_BUILDING_QX_ORM
...
#define QX_DLL_EXPORT_QX_SINGLETON_CPP(x)                                      \
  QX_DLL_EXPORT_TEMPLATE_CPP(class, qx::QxSingleton<x>)
#else                                     // _QX_BUILDING_QX_ORM
