 ...
 * \author Lionel Marty
 * \ingroup QxTraits
 * \brief qx::trait::get_class_name<T>::get() : return class name of type T
 * under const char * format, T must be registered with
 * QX_REGISTER_CLASS_NAME(T) macro
 */
...
#define QX_GET_CLASS_NAME_XML_TAG_STD_STR(TYPE)                                \
  QString::fromLatin1(qx::trait::get_class_name<                               \
                      qx::trait::remove_attr<TYPE>::type>::get_xml_tag())
...
#define QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(TYPE)                          \
  QString::fromLatin1(qx::trait::get_class_name<                               \
                      typename qx::trait::remove_attr<TYPE>::type>::get())

#define QX_GET_CLASS_NAME_XML_TAG_WITH_TYPENAME(TYPE)                          \
  qx::trait::get_class_name<                                                   \
      typename qx::trait::remove_attr<TYPE>::type>::get_xml_tag()
...
#define QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG()                          \
  static inline const char *get_xml_tag() {                                    \
    static QString result_xml;                                                 \
    if (!result_xml.isEmpty()) {                                               \
      return result_xml.toLatin1().constData();                                \
    }                                                                          \
    QString tmp = QString::fromLatin1(get_class_name::get());                  \
    tmp.replace(QX_REGISTER_CLASS_NAME_SEP_INF,                                \
                QX_REGISTER_CLASS_NAME_SEP_INF_XML_TAG);                       \
    tmp.replace(QX_REGISTER_CLASS_NAME_SEP_SUP,                                \
...
#ifdef _QX_NO_RTTI
#define QX_REGISTER_CLASS_NAME_NO_RTTI(className) QLatinString(#className)
#endif // _QX_NO_RTTI
 ...
 * QX_REGISTER_CLASS_NAME(T) macro
 */
template <typename T> struct get_class_name {
  ...
  static inline const char *get() {
    ...
    T *dummy = NULL;
    Q_UNUSED(dummy);
    result = QString().fromLatin1(typeid(dummy).name());
#else  // _QX_NO_RTTI
    result = QX_REGISTER_CLASS_NAME_NO_RTTI(T);
#endif // _QX_NO_RTTI

    qDebug(
        "[QxOrm] Unable to define correct class name : '%s' => use macro "
        "'QX_REGISTER_CLASS_NAME()' or 'QX_REGISTER_CLASS_NAME_TEMPLATE_X()'",
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_INIT(className)                        \
  static QString result;                                                       \
  if (!result.isEmpty()) {                                                     \
    const char *data = result.toLatin1().constData();                          \
...
#define QX_REGISTER_CLASS_NAME(className)                                      \
  namespace qx {                                                               \
  namespace trait {                                                            \
  template <> struct get_class_name<className> {                               \
    static inline const char *get() {                                          \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_1(className)                           \
  namespace qx {                                                               \
  namespace trait {                                                            \
  template <typename T> struct get_class_name<className<T>> {                  \
    static inline const char *get() {                                          \
      QX_REGISTER_CLASS_NAME_TEMPLATE_INIT(className);                         \
      result += QX_REGISTER_CLASS_NAME_SEP_INF +                               \
                QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T) +                   \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_2(className)                           \
  ...
  struct get_class_name<className<T1, T2>> {                                   \
    static inline const char *get() {                                          \
      QX_REGISTER_CLASS_NAME_TEMPLATE_INIT(className);                         \
      result += QX_REGISTER_CLASS_NAME_SEP_INF +                               \
                QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T1) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T2) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_3(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3>> {                               \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T2) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T3) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_4(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3, T4>> {                           \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T3) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T4) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_5(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3, T4, T5>> {                       \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T4) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T5) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_6(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3, T4, T5, T6>> {                   \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T5) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T6) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_7(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3, T4, T5, T6, T7>> {               \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T6) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T7) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_8(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3, T4, T5, T6, T7, T8>> {           \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T7) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T8) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
...
#define QX_REGISTER_CLASS_NAME_TEMPLATE_9(className)                           \
  ...
  struct get_class_name<className<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {       \
    static inline const char *get() {                                          \
      ...
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T8) +                  \
                QX_REGISTER_CLASS_NAME_SEP_NXT;                                \
      result += QX_GET_CLASS_NAME_STD_STR_WITH_TYPENAME(T9) +                  \
                QX_REGISTER_CLASS_NAME_SEP_SUP;                                \
      return result.toLatin1().constData();                                    \
    }                                                                          \
    QX_GET_CLASS_NAME_IMPLEMENT_FCT_GET_XML_TAG();                             \
