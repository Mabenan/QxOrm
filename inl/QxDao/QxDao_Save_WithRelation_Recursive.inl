...
struct QxDao_Save_WithRelation_Recursive_Generic
{
   ...
   static QSqlError save(T & t, qx::dao::save_mode::e_save_mode eSaveMode, QSqlDatabase * pDatabase, qx::QxSqlRelationParams * pRelationParams)
   {
       ...
       qx::dao::detail::QxDao_Helper<T> dao(t,
                                            pDatabase,
                                            "save with relation recursive",
                                            new qx::QxSqlQueryBuilder_Update<T>());
       if (!dao.isValid()) {
           return dao.error(); }
...
} static inline bool hierarchyOnBeforeSave(qx::dao::save_mode::e_save_mode eSaveMode,
                                           qx::QxSqlRelationParams *pRelationParams,
                                           U &item,
                                           qx::dao::detail::QxDao_Helper_Container<T> &dao)
