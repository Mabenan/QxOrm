...
template <> struct QxConvert_ToString<qx::trait::no_type> {
    static inline QString toString(qx::trait::no_type &t,
...
template <> struct QxConvert_ToString<QUuid> {
    static inline QString toString(QUuid &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
template <> struct QxConvert_ToString<QDate> {
    static inline QString toString(QDate &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return t.toString(format.isEmpty() ? QStringLiteral(QX_STR_CVT_QDATE_FORMAT)
                                           : format);
    }
};

template <> struct QxConvert_ToString<QTime> {
    static inline QString toString(QTime &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return t.toString(format.isEmpty() ? QStringLiteral(QX_STR_CVT_QTIME_FORMAT)
                                           : format);
    }
};
...
template <> struct QxConvert_ToString<QDateTime> {
    static inline QString toString(const QDateTime &t, const QString &format,
        ...
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return t.toString(format.isEmpty() ? QStringLiteral(QX_STR_CVT_QDATETIME_FORMAT)
                                           : format);
    }
};
...
template <> struct QxConvert_ToString<QVariant> {
    static inline QString toString(const QVariant &t, const QString &format,
        ...
        if (qx::cvt::detail::helper::checkConvertQVariantToString(t)) {
            QString type =
                QStringLiteral("%1").arg(static_cast<int>(t.type()), 6, 10, QChar('0'));
            QString val = "$$JSON$$" + type + "$$";
            QJsonValue json = QJsonValue::fromVariant(t);
            QJsonDocument doc = (json.isArray() ? QJsonDocument(json.toArray())
...
template <> struct QxConvert_ToString<bool> {
    static inline QString toString(bool &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
template <> struct QxConvert_ToString<char> {
    static inline QString toString(char &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
template <> struct QxConvert_ToString<short> {
    static inline QString toString(short &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
                                 : QString().asprintf(qPrintable(format), t));
    }
};

template <> struct QxConvert_ToString<int> {
    static inline QString toString(int &t, const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<long> {
    static inline QString toString(long &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<long long> {
    static inline QString toString(long long &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<float> {
    static inline QString toString(float &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<double> {
    static inline QString toString(double &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<unsigned short> {
    static inline QString toString(unsigned short &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<unsigned int> {
    static inline QString toString(unsigned int &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<unsigned long> {
    static inline QString toString(unsigned long &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        return (format.isEmpty() ? QString::number(t)
...
template <> struct QxConvert_ToString<unsigned long long> {
    static inline QString toString(unsigned long long &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
template <> struct QxConvert_ToString<qx::QxDateNeutral> {
    static inline QString toString(const qx::QxDateNeutral &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <> struct QxConvert_ToString<qx::QxTimeNeutral> {
    static inline QString toString(const qx::QxTimeNeutral &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <> struct QxConvert_ToString<qx::QxDateTimeNeutral> {
    static inline QString toString(const qx::QxDateTimeNeutral &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <> struct QxConvert_ToString<QJsonValue> {
    static inline QString toString(const QJsonValue &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(index);
        Q_UNUSED(ctx);
        ...
        if (!format.isEmpty()) {
            jsonFormat =
                ((format == QLatin1String("indented")) ? QJsonDocument::Indented : jsonFormat);
        }
        QJsonDocument doc = (t.isArray() ? QJsonDocument(t.toArray())
                                         : QJsonDocument(t.toObject()));
...
template <typename T> struct QxConvert_ToString<boost::optional<T>> {
    static inline QString toString(const boost::optional<T> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        if (t) {
...
struct QxConvert_ToString<std::pair<T1, T2>> {
    static inline QString toString(const std::pair<T1, T2> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <typename T> struct QxConvert_ToString<boost::unordered_set<T>> {
    static inline QString toString(const boost::unordered_set<T> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <typename T> struct QxConvert_ToString<boost::unordered_multiset<T>> {
    static inline QString toString(const boost::unordered_multiset<T> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <typename T> struct QxConvert_ToString<std::unordered_set<T>> {
    static inline QString toString(const std::unordered_set<T> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <typename T> struct QxConvert_ToString<std::unordered_multiset<T>> {
    static inline QString toString(const std::unordered_multiset<T> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <typename T> struct QxConvert_ToString<QFlags<T>> {
    static inline QString toString(const QFlags<T> &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
struct QxConvert_ToString<std::map<Key, Value>> {
    static inline QString toString(const std::map<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::unordered_map<Key, Value>> {
    static inline QString toString(const boost::unordered_map<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::unordered_multimap<Key, Value>> {
    static inline QString toString(const boost::unordered_multimap<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::unordered_map<Key, Value>> {
    static inline QString toString(const std::unordered_map<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::unordered_multimap<Key, Value>> {
    static inline QString toString(const std::unordered_multimap<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<QHash<Key, Value>> {
    static inline QString toString(const QHash<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<QMultiHash<Key, Value>> {
    static inline QString toString(const QMultiHash<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<QMap<Key, Value>> {
    static inline QString toString(const QMap<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<QMultiMap<Key, Value>> {
    static inline QString toString(const QMultiMap<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<qx::QxCollection<Key, Value>> {
    static inline QString toString(const qx::QxCollection<Key, Value> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
template <typename T1> struct QxConvert_ToString<boost::tuple<T1>> {
    static inline QString toString(const boost::tuple<T1> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::tuple<T1, T2>> {
    static inline QString toString(const boost::tuple<T1, T2> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3>> {
    static inline QString toString(const boost::tuple<T1, T2, T3> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3, T4>> {
    static inline QString toString(const boost::tuple<T1, T2, T3, T4> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3, T4, T5>> {
    static inline QString toString(const boost::tuple<T1, T2, T3, T4, T5> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3, T4, T5, T6>> {
    static inline QString toString(const boost::tuple<T1, T2, T3, T4, T5, T6> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3, T4, T5, T6, T7>> {
    ...
    toString(const boost::tuple<T1, T2, T3, T4, T5, T6, T7> &t,
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8>> {
    static inline QString
    toString(const boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8> &t,
             const QString &format, int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
struct QxConvert_ToString<boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
    static inline QString
    toString(const boost::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> &t,
             const QString &format, int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
template <typename T1> struct QxConvert_ToString<std::tuple<T1>> {
    static inline QString toString(const std::tuple<T1> &t, const QString &format,
                                   int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
struct QxConvert_ToString<std::tuple<T1, T2>> {
    static inline QString toString(const std::tuple<T1, T2> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3>> {
    static inline QString toString(const std::tuple<T1, T2, T3> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3, T4>> {
    static inline QString toString(const std::tuple<T1, T2, T3, T4> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3, T4, T5>> {
    static inline QString toString(const std::tuple<T1, T2, T3, T4, T5> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3, T4, T5, T6>> {
    static inline QString toString(const std::tuple<T1, T2, T3, T4, T5, T6> &t,
                                   const QString &format, int index,
                                   qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3, T4, T5, T6, T7>> {
    static inline QString
    toString(const std::tuple<T1, T2, T3, T4, T5, T6, T7> &t,
             const QString &format, int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3, T4, T5, T6, T7, T8>> {
    static inline QString
    toString(const std::tuple<T1, T2, T3, T4, T5, T6, T7, T8> &t,
             const QString &format, int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
...
struct QxConvert_ToString<std::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
    static inline QString
    toString(const std::tuple<T1, T2, T3, T4, T5, T6, T7, T8, T9> &t,
             const QString &format, int index, qx::cvt::context::ctx_type ctx) {
        Q_UNUSED(format);
        Q_UNUSED(index);
        Q_UNUSED(ctx);
