...
template <> struct QxConvert_ToString<qx::trait::no_type> {
  static inline QString toString(const qx::trait::no_type &t,
...
template <> struct QxConvert_ToString<QUuid> {
  static inline QString toString(const QUuid &t, const QString &format,
                                 int index, qx::cvt::context::ctx_type ctx) {
    Q_UNUSED(format);
    Q_UNUSED(index);
    Q_UNUSED(ctx);
...
template <> struct QxConvert_ToString<QDate> {
  static inline QString toString(const QDate &t, const QString &format,
    ...
    Q_UNUSED(index);
    Q_UNUSED(ctx);
    return t.toString(format.isEmpty() ? QString(QX_STR_CVT_QDATE_FORMAT)
                                       : format);
  }
};
...
template <> struct QxConvert_ToString<QTime> {
  static inline QString toString(const QTime &t, const QString &format,
    ...
    Q_UNUSED(index);
    Q_UNUSED(ctx);
    return t.toString(format.isEmpty() ? QString(QX_STR_CVT_QTIME_FORMAT)
                                       : format);
  }
};
...
template <> struct QxConvert_ToString<QDateTime> {
  static inline QString toString(const QDateTime &t, const QString &format,
    ...
    Q_UNUSED(index);
    Q_UNUSED(ctx);
    return t.toString(format.isEmpty() ? QString(QX_STR_CVT_QDATETIME_FORMAT)
                                       : format);
  }
};
...
template <> struct QxConvert_ToString<QVariant> {
  static inline QString toString(const QVariant &t, const QString &format,
    ...
    if (qx::cvt::detail::helper::checkConvertQVariantToString(t)) {
      QString type =
          QString("%1").arg(static_cast<int>(t.type()), 6, 10, QChar('0'));
...
template <> struct QxConvert_ToString<unsigned long long> {
  static inline QString toString(const unsigned long long &t,
                                 const QString &format, int index,
                                 qx::cvt::context::ctx_type ctx) {
    Q_UNUSED(index);
    Q_UNUSED(ctx);
...
template <> struct QxConvert_ToString<QJsonValue> {
  static inline QString toString(const QJsonValue &t, const QString &format,
    ...
    if (!format.isEmpty()) {
      jsonFormat =
          ((format == "indented") ? QJsonDocument::Indented : jsonFormat);
    }
